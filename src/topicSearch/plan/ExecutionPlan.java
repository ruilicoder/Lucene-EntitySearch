...
public abstract class ExecutionPlan {
	...
	public HashMap<String,Integer> getEntities(HashMap<Integer,HashSet<Integer>> map , TopicIDIndex eti) {
		...
		for (Integer x:result.keySet()) {
			String entity = eti.getTopic(x);
			res.put(entity,result.get(x));
		}
		return res;
	}
	/*public HashMap<String,Integer> getEntities(HashMap<Integer,HashSet<Integer>> map , TopicIDIndex eti, int type) {
		HashMap<Integer,Integer> result = new HashMap<Integer,Integer>();
