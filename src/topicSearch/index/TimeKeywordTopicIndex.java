...
public class TimeKeywordTopicIndex {
	IndexReader reader;

	public TimeKeywordTopicIndex(String indexDir) {
		try {
	...
	public HashMap<Integer, HashSet<Integer>> getDocumentEntityPairs(String type, String term) {
		HashMap<Integer, HashSet<Integer>> map = new HashMap<Integer, HashSet<Integer>>();
		TermPositions tps = getDocumentPositions(type,term);
	...
	public TermPositions getDocumentPositions(String type, String term) {
		// reader.termDocs(t)
		Term t = new Term(type, term);
		// reader.termDocs(t)
		try {
	...
	public static String index = "timekeywordDocumentTopicIndex";

	public static void buildIndex(String fromFile, String fromFile2, String fromFile3,
			String toDir) {
		try {
			...
			BufferedReader reader2 = new BufferedReader(new FileReader(
					fromFile2));
			BufferedReader reader3 = new BufferedReader(new FileReader(fromFile3));
			...
			for (int i = 0; i < Configure.DOCNUM; i++) {
				...
				String time = reader3.readLine();
				Document doc = buildDocument(content, topics, time);
	...
	public static void insert(String fromFile, String fromFile2, String fromFile3, String toDir) {
		try {
			BufferedReader reader1 = new BufferedReader(
					new FileReader(fromFile));
			BufferedReader reader2 = new BufferedReader(new FileReader(
	...
	public static Document buildDocument(String content, String entity, String time) {
		if (entity.compareTo("") == 0)
			return new Document();
		if (content.compareTo("") == 0)
			return new Document();
		Document doc = new Document();
		doc.add(new Field(time, content + " entityrli " + entity,
