...
public class SmallTableAndViewGenerator {
...
//	public static int max_doc = 10000;
//	public static int max_keywords = 1000;
	...
	public static void reWriteKeywordTable() {
		try {
			printer = new PrintWriter(new FileWriter(dir + "keywordDocument4.txt"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		// int id = 1;
	...
	public static void printV4KT() {
		try {
			printer = new PrintWriter(new FileWriter(dir + "v4td.txt"));
