...
public class StopWord {
	public static String[] stopwords = {"a", "b", "c", "d", "e", "f", "g", "h","i","j","k","l","m","n","o","p","q", "r", "s", "t", "u", "v", "w", "x","y","z","&nbsp", "a\'s", "able", "about", "above",
			...
			"further", "furthermore", "got", "get", "gets", "getting", "given",
			...
			"hither", "hopefully", "how", "howbeit", "however", "i", "i'd",
			...
			"yourself", "yourselves", "zero", "a", "about", "above", "above",
